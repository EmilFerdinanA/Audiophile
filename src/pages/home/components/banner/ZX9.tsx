...
export const ZX9 = () => {
  return (
    <div
      className={
        "h-[37.5rem] md:h-[45rem] lg:h-[35rem] px-6 lg:px-[5rem] xl:px-[10rem] rounded-lg text-white containers flex-col lg:flex-row lg:!items-end lg:!justify-between gap-9 xl background-zx9"
      }
    >
      ...
      <div className="containers flex-col text-center lg:text-left lg:!items-start lg:!justify-start lg:pt-28 pl-20 gap-6 md:w-[21.813rem] lg:w-1/2 lg:h-full">
